            ...
            <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                <div class="card border-0 shadow-lg rounded-4" style="background-color: #ffffff;">
                    <div class="card-body p-4">
                     ...
                     <h5 class="text-center mt-3 mb-4 login-text">Register as User</h5>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="d-flex flex-column flex-md-row justify-content-center gap-2">
                                    <a href="{{ route('account.login') }}" class="link-primary text-decoration-none fw-semibold">
                                        Already have an account? Login here
                                    </a>
                                </div>
                                <hr>
                                <div class="d-flex flex-column flex-md-row justify-content-center gap-2">
                                    <a href="{{ route('register-trainer') }}" class="link-primary text-decoration-none fw-semibold">
